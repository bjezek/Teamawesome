...
(The calculations made for the trading model described above were done in the file DogeTuesFridayModelCalcCheck.ipynb and checked again in the Resources file DOGE_prophet_model_returns_calc_check.xlsx)
